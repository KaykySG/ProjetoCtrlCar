...
public class CadTipoDeGasto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldCadTipoDeGasto = new javax.swing.JTextField();
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 263, -1));
        ...
        jTextFieldCadTipoDeGasto.setBackground(new java.awt.Color(255, 255, 255));
        jPanel1.add(jTextFieldCadTipoDeGasto, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 160, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        TipoDeGastos tipoDeGasto = new TipoDeGastos(0, jTextFieldCadTipoDeGasto.getText());
        tipoDeGastosDao tipoGasotoDao = new tipoDeGastosDao();
    
        this.dispose();
        
        tipoGasotoDao.adicionar(tipoDeGasto);
 
        } catch (Exception ex) {
            System.out.println(ex);
        }
        jTextFieldCadTipoDeGasto.setText("");
    ...
    private javax.swing.JTextField jTextFieldCadTipoDeGasto;
